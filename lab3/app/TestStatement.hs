...
p12 = fromString "begin read n ; s := 0; repeat begin s:=s+n; n:=n-1; end until (0-n)+1; write s; end"
p13 = fromString "repeat begin s := 0; end until s;"
testStatement = toString p12
